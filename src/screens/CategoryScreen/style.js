...
export const styles = StyleSheet.create({
    ...
    listItem: { flex: 0.33, alignItems: 'center', position: 'relative', margin: 5},
    ...
    productDetails: {margin: 10, position: 'absolute', bottom: -10, backgroundColor: 'white', width: '100%', opacity: 0.8},
    name: { textAlign: 'center', fontFamily: 'ZenLoop-Italic' },
    price: { textAlign: 'center', fontFamily: 'ZenLoop-Regular', color: 'rgb(90,90,90)' },
    longName: { marginTop: 4, color: "#999", fontFamily: 'ZenLoop-Regular-Regular', textAlign: 'justify', fontSize: 11 }
});